<?php
	class barang
	{
		...
		function getNama_Barang ($nama_barang)
		{
			return $nama_barang;
		}
		function getHarga_Barang ($harga_barang)
		{
			return $harga_barang;
		}
		function getBiaya_Penyimpanan ($biaya_penyimpanan)
		{
			return $biaya_penyimpanan;
		}
		function getPeriode_Permintaan ($periode_permintaan)
		{
		...
		function AddBarang ()
		{
			...
			$sqlAddBarang = mysqli_query ($conn, "INSERT INTO barang (nama_barang, harga_barang, biaya_penyimpanan, periode_permintaan, satuan, konversi) VALUES ('$this->nama_barang','$this->harga_barang','$this->biaya_penyimpanan', '$this->periode_permintaan','$this->satuan','$this->konversi')");
		}
		function BarangList ()
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlBarangList = mysqli_query ($conn, "SELECT * FROM barang ORDER BY nama_barang ASC");
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlEditBarang = mysqli_query ($conn, "SELECT * FROM barang WHERE id_barang = '$id'");
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlBarangUpdate = mysqli_query ($conn, "UPDATE barang SET nama_barang = '$this->nama_barang', harga_barang = '$this->harga_barang', biaya_penyimpanan = '$this->biaya_penyimpanan', periode_permintaan = '$this->periode_permintaan', satuan ='$this->satuan', konversi = '$this->konversi' WHERE id_barang = '$this->id_barang'");
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlBarangDelete = mysqli_query ($conn, "DELETE FROM barang WHERE id_barang = '$id'");
		}
		function StokBarang ()
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlStokBarang = mysqli_query ($conn, "SELECT
						barang.nama_barang,	
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlBE = mysqli_query ($conn, "SELECT
					barang.nama_barang,
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlEOQ = mysqli_query ($conn, "SELECT
							barang.nama_barang,
							barang.harga_barang,
							barang.konversi,
		...
		{
			$conn = mysqli_connect("localhost", "root", "", 'eoq_tk4');
			$sqlROP = mysqli_query ($conn, "SELECT
						barang.nama_barang,
						barang.harga_barang,
						barang.satuan,
						barang.konversi,
